...
# Доработан класс Ship - при инстанцировании объекта, класс вызывается без аргументов
...
class Ship(games.Sprite):
    ...
    def __init__(self):
        super().__init__(image=Ship.image, x=games.screen.width/2, y=games.screen.height/2)
