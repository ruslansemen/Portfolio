        ...
        while 1:
            if self.running == True:
                ...
                self.canvas.create_text(
                    270, 50, text='Вы победили', font=('Courier', 30))
...
class StickFigureSprite(Sprite):
    def __init__(self, game):
        Sprite.__init__(self, game)
        self.images_left = [PhotoImage(file='figure-L1.gif'), PhotoImage(
            file='figure-L2.gif'), PhotoImage(file='figure-L3.gif')]
        self.images_right = [PhotoImage(
            file='figure-R1.gif'), PhotoImage(file='figure-R2.gif'), PhotoImage(file='figure-R3.gif')]
        self.image = game.canvas.create_image(
...
g = Game()
platform1 = PlatformSprite(g, PhotoImage(
